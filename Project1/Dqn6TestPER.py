...
class DQNAgent:
    def __init__(self, state_shape, action_space, gamma=0.90, decay_episodes = 200, epsilon=0.9, epsilon_min=0.05, epsilon_decay=0.995, batch_size=200, memory_size=4000, alpha=0.6, beta=0.4, beta_increment=0.001):
        self.state_shape = state_shape
        self.action_space = action_space
        self.gamma = gamma
