...
from Project5.Dqn10NOPERCNN import DQNAgent
import numpy as np
import random
...
"""Finora questo modello ci ha dato risultati molto promettenti in poche epoche"""
...
def plot_results(max_tile, match_score, loss):
        ...
        plt.savefig('plots/resultCNN_NOPER.png')
...
if __name__ == "__main__":
    ...
    log_file = "log_csv/debug_log_sequentialCNN_NOPER.csv"

    counterPrint = 0
    episode = 0
    save_directory, load_directory = "agent_savesCNN_NOPER", "agent_savesCNN_NOPER"
    resume = True
    start_episode = 700
